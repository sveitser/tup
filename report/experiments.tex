...
\subfigure[$\kappa_\textrm{LDA}$]{
	\includegraphics[width=\figwidth,height=\figheigt]{kappa_lda}
	\label{fig:kappa_lda}
}
\subfigure[$\kappa_\textrm{TATM1}$]{
	\includegraphics[width=\figwidth,height=\figheigt]{kappa_tatm1}
	\label{fig:kappa_tatm1}
}
\subfigure[$\kappa_\textrm{TATM2}$]{
	\includegraphics[width=\figwidth,height=\figheigt]{kappa_tatm2}
	\label{fig:kappa_tatm2}
}
\subfigure[$\tau_\textrm{LDA}$]{
	\includegraphics[width=\figwidth,height=\figheigt]{tau_lda}
	\label{fig:tau_tatm2}
}
\subfigure[$\kappa_\textrm{LDA}$]{
	\includegraphics[width=\figwidth,height=\figheigt]{batch_lda}
	\label{fig:batch_lda}
}
\subfigure[$\kappa_\textrm{TATM1}$]{
	\includegraphics[width=\figwidth,height=\figheigt]{batch_tatm1}
	\label{fig:batch_tatm1}
}
\subfigure[$\kappa_\textrm{TATM2}$]{
	\includegraphics[width=\figwidth,height=\figheigt]{batch_tatm2}
